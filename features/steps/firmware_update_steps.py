...
def step_impl(context):
    assert hasattr(context, 'active_firmware'), "Context variable 'active_firmware' is not set. Ensure 'the sensor has an active firmware version' step is used."
    assert hasattr(context, 'new_firmware'), "Context variable 'new_firmware' is not set. Ensure 'a new firmware version is attempted' step is used."
...
def step_impl(context):
    assert hasattr(context, 'previous_firmware'), "Context variable 'previous_firmware' is not set."
